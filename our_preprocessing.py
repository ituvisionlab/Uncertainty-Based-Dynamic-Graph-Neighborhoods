...
pancreas_dir = "./our_pancreas_train_with_graph/pancreas_ct/Pancreas-CT/"
label_dir = "./our_pancreas_train_with_graph/pancreas_ct/TCIA_pancreas_labels-02-05-2017/"
temp_dir = []
data_dir = []

pancreas_list = os.listdir(pancreas_dir) #"[PANCREAS_XXXX,...]"
pancreas_list = sorted(pancreas_list)

label_list = os.listdir(label_dir) #[label0001.nii.gz...]
